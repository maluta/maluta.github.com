...
- Apresentar o resultado ``print``

Traduzinho para o Python:
...
Leia devagar, experimente pequenas modificações e veja o que acontece.
...
apenas compondo as *strings* com um parâmetro de definição de cor. Se você estiver
