---
layout: post
title: Básico de ponteiros com o GDB
tags: [oldblog]
---

<small>[Warning: This post is a backup recovery from my previous Wordpress blog. All content was automatically converted accessing a MySQL database using a Python script (<a href="/convert-wordpress-to-jekyll/">details</a>). Mostly are in Portuguese but if you are interest I can translate to English. If you found any problem dont't hesitate to contact me in comments.]</small>



<p style="text-align: justify;">Esse é um pequeno lembrete para quem quer pegar o conceito de ponteiro rápido. É tão simples que nem programa direito você vai precisar, só seguir sua intuição e o GDB ;-)</p>
...
<tt>(gdb) <strong>l</strong> <span style="color: red; ">(lista o código)</span></tt>
...
<tt>$2 = 18</tt>
<span style="color: red; "><tt>(Imprime o conteúdo do endereço definido em ptr)</tt></span><tt></tt>
<tt>(gdb) <strong>print</strong> *ptr </tt>
<tt>Cannot access memory at address 0x0 <span style="color: red; ">(ooops... essa não é uma posição válida!)</span></tt>
<tt>(gdb) <strong>print</strong> ptr <span style="color: red; "> (mas é claro que ptr guarda um valor...)</span></tt>
<tt>$3 = (int *) 0x0 <span style="color: red; ">(que é NULL)</span></tt></div>
<tt>
</tt>
<div class="indent"><span style="color: red; "><tt>(E qual o endereço da variável_A?)</tt></span>
<tt>(gdb) <strong>print</strong> &amp;variavel_A</tt>
<tt>$4 = (int *) <span style="color: green; ">0xbfbc0ddc</span></tt>
<tt>(gdb) <strong>print</strong> *variavel_A <span style="color: red; ">(Podemos ver que não conseguimos acessar a variavel_A como um ponteiro pois ela guarda um endereço inválido)</span></tt>
<tt>Cannot access memory at address 0x5</tt></div>
<tt>
</tt>
<div class="indent"><span style="color: red; "><tt>(O endereço da variável_B)</tt></span><tt></tt>
<tt>(gdb) <strong>print</strong> &amp;variavel_B</tt>
...
<tt>(gdb) <strong>print</strong> *ptr <span style="color: red; ">(e mostrar o seu conteúdo)</span></tt>
<tt>$6 = 5</tt>
...
<tt>$1 = 0xb80b1190 "U\211åWVSèÀ\207" <span style="color: red; ">(LIXO)</span></tt>
<tt>(gdb) <strong>n</strong> <span style="color: red; ">(next - executa a próxima instrução)</span></tt>
...
<span style="color: red; "><tt>(Vamos colocar um espaço em branco na segunda posição)</tt></span><tt></tt>
<tt>(gdb) <strong>set</strong> {char}(nome+1)=' ' <span style="color: red; ">(lembre-se que o índice começa em zero)</span></tt>
<tt>(gdb) <strong>print</strong> nome</tt>
...
<tt> <span style="color: red; ">(Você pode ver o conteúdo da variável com deslocamento 'offset')</span></tt>
...
<div class="indent"><span style="color: red; "><tt>(Qual o endereço da função somaMinhaClasse?)</tt></span><tt></tt>

<tt>(gdb) <strong>print</strong> somaMinhaClasse</tt>

<tt>$3 = {int (struct MinhaClasse *)} 0x80483d0 &lt;somaMinhaClasse&gt;</tt></div>
<div class="indent"><span style="color: red; "><tt>(Que interessante... objeto.soma e somaMinhaClasse tem o mesmo endereço?)</tt></span><tt></tt>

<tt>(gdb) <strong>print</strong> objeto.soma</tt>

<tt>$4 = (int (*)()) 0x80483d0 &lt;somaMinhaClasse&gt;</tt></div>
<div class="indent"><span style="color: red; "><tt>(E a função subtraiMinha classe está sozinha?)</tt></span><tt></tt>
...
<div class="indent"><span style="color: red; "><tt>(Que tal conectá-la a alguém?)</tt></span><tt></tt>

<tt>(gdb) <strong>set</strong> objeto.soma=subtraiMinhaClasse</tt>

<span style="color: red; "><tt>(E lógico ver o resultado!)</tt></span><tt></tt>
...
<div class="indent"><span style="color: red; "><tt>(Não gostei! Quero voltar para o que tinha antes)</tt></span><tt></tt>
